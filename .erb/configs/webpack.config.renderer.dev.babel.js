...
export default merge(baseConfig, {
	...
	entry: ['webpack-dev-server/client?http://localhost:1212/dist', 'webpack/hot/only-dev-server', 'core-js', 'regenerator-runtime/runtime', path.join(webpackPaths.srcRendererPath, 'index.tsx')],
